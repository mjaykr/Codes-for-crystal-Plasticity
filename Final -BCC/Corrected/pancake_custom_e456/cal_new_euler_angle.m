...
function new_euler_angle = cal_new_euler_angle(euler_angle,strain_external,strain_increment)
...
while i7<=1
    ...
    if isempty(independent_slip_system)
        ...
        for counter9=1:1:size(independent_slip_system,1)
            three_by_three(:,:,counter9) = [independent_slip_system(counter9,1);independent_slip_system(counter9,2);independent_slip_system(counter9,3)]*[independent_slip_system(counter9,4) independent_slip_system(counter9,5) independent_slip_system(counter9,6)];
        end
