...
dummy_m = nchoosek(1:1:size(possible_slip_system,1),5);


for var1=1:1:size(dummy_m,1)
    generate_mat = [];
    for var2 = 1:1:size(dummy_m,2)
        generate_mat = [generate_mat;possible_slip_system(dummy_m(var1,var2),:)];
...
Net_rotaion = sqrt((w12*w12) + (w13*w13) + (w23*w23));
r1 = (w23/Net_rotaion); r2 = (w13/Net_rotaion); r3 = (w12/Net_rotaion);
