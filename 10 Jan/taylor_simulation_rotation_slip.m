...
if isempty(probable_independent_slip_system)
    ...
    if length(store_page_no_of_fivebyfive_mat)== length (all_rotation)
...
w12 = (e12-e21)/4.88; w31 = (e31-e13)/4.88; w23 = (e23-e32)/4.88;
        ...
        r1 = (-w23/Net_rotation_min); r2 = (-w31/Net_rotation_min); r3 = (-w12/Net_rotation_min);
        axis_angle_pair = [r1 r2 r3 Net_rotation_min];
